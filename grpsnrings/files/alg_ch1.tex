...
\lemp{}{If $1\leq a \leq n$, with $n \geq 2$, and $(a,n)=j\neq 1 (\geq 2)$, then there exists a number $1 \leq b<n$}{}
...
\\\\ Consider $\overline{a}\in A$. There exists $\overline{c} \in \ZZ/ n \ZZ$
so that $\overline{a} \cdot \overline{c}=\overline{1}$. 
